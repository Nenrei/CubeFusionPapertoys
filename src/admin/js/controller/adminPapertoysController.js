 ...
 */
angular.module("appAdmin").controller("adminPapertoysController", function ($http, service, $window) {
    ...
    me.currentView = 'view/adminPapertoys/listPapertoys.html';
    ...
    me.openReadPanel = function (papertoy) {
        ...
        me.currentView = 'view/adminPapertoys/crudPapertoys.html';
    };
